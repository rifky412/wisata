...
if (isset($_POST['submit'])) {
    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            $sql = "INSERT INTO register (username, email, password, nomer_hp, alamat, gender)
                    VALUES ('$username', '$email', '$password', '$nomer_hp', '$alamat', '$gender')";
            $result = mysqli_query($conn, $sql);
            if ($result) {
...
<body>
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
                <input type="text" placeholder="Nomer HP" name="nomer_hp" value="<?php echo $nomer_hp; ?>" required>
            </div>
            <div class="input-group">
